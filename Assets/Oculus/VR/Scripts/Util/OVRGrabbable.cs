...
public class OVRGrabbable : MonoBehaviour
{
    ...
    public OVRGrabber GrabbedBy { get => m_grabbedBy; private set => m_grabbedBy = value; }

   
    /// <summary>
    /// Se agrego funcion pero esta sin Utilizar, pensar en retirar
    /// </summary>
    public void SoltarDeMano()
    {
        if (!m_grabbedBy)
            return;
        m_grabbedBy.ForceRelease(this);
        //m_grabbedBy.GrabEndCall();
    }
